...
<header class="row">
    ...
    <div class="log-out col mt-3 mb-3 text-right"><a href="/logout"><i class="fa fa-sign-out" aria-hidden="true"></i> Выход</a></div>
</header>
<div class="row">
    <nav class="col col-xl-4 mt-2 text-justify">
